...
admin_sticker_change_delete = CallbackData("change_sticker_delete", "action", "sticker_id")
    ...
    admin_sticker_change = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="Soni",
                    callback_data=admin_sticker_change_quantity.new(action="change_sticker_quantity",sticker_id=sticker_id)),
                InlineKeyboardButton(
                    text="O'chirish",
                    callback_data=admin_sticker_change_delete.new(action="change_sticker_delete",
                                                                    sticker_id=sticker_id))
            ]
        ]
    )
